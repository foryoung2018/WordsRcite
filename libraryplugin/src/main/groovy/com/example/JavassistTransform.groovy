        ...
        inputs.each { TransformInput input ->
            try {
                input.jarInputs.each {
                    TimeInject.injectDir(it.file.getAbsolutePath(), "com", project)
...
//                project.logger.err e.getMessage()
            ...
            input.directoryInputs.each { DirectoryInput directoryInput ->
                ...
                TimeInject.injectDir(directoryInput.file.absolutePath, "com", project)
                // 获取output目录
...
//        project.logger.error("*** yang","JavassistTransform cast :" + (System.currentTimeMillis() - startTime) / 1000 + " secs");
    }
}