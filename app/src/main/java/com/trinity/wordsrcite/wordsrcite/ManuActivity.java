...
import com.trinity.wordsrcite.wordsrcite.viewholder.StringViewHolder;
...
/**
 * Created by foryoung on 2018/4/24.
 */
...
//        recyclerView.enableLoadmore();//开启上拉加载更多
    ...
    class StringAdapter extends UltimateViewAdapter<StringViewHolder> {
        ...
        public StringViewHolder onCreateViewHolder(ViewGroup parent) {
            View view  = LayoutInflater.from(ManuActivity.this).inflate(R.layout.string_item,null);
