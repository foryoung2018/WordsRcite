...
public class ToastUtil {
    ...
    public static void showShortToast(String msg) {
        if(MyApplication.getGlobalContext() != null){
            if (toast == null) {
                toast = Toast.makeText(MyApplication.getGlobalContext(), msg, Toast.LENGTH_SHORT);
            } else {
                toast.setText(msg);
            }
            ...
            toast.setGravity(Gravity.BOTTOM, 0, dip2px(MyApplication.getGlobalContext(),64));
            toast.show();
        }
    }
    /**
    ...
    public static void showLongToast(String msg) {
        if(MyApplication.getGlobalContext() != null) {
            if (toast == null) {
                toast = Toast.makeText(MyApplication.getGlobalContext(), msg, Toast.LENGTH_LONG);
            } else {
                toast.setText(msg);
            }
            toast.setGravity(Gravity.BOTTOM, 0, dip2px(MyApplication.getGlobalContext(),64));
