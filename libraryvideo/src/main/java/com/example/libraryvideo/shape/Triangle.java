package com.example.libraryvideo.shape;

import android.opengl.GLES20;

import com.example.libraryvideo.ActivityOne;
...
Program - An OpenGL ES object that contains the shaders you want to use for drawing one or more shapes.
    ...
    public Triangle() {
        ...
        int vertexShader = RenderUtil.loadShader(GLES20.GL_VERTEX_SHADER,
                vertexShaderCode1);
        int fragmentShader = RenderUtil.loadShader(GLES20.GL_FRAGMENT_SHADER,
                fragmentShaderCode);
